import { HTMLField } from "@client/data/fields.mjs";
...
declare module "./itemBase.mjs" {
  export default interface muItemBaseModel extends muSystemModel {
    details: {
      costUnit: int;
      costBulk: int;
      descritpion: HTML;
